...
public class NormalDistributionTest {
    ...
    @Test
    public void testStdNormalCdf1() {
        double expectedCdf = .5;
        double actualCdf = NormalDistribution.StandardNormal.cdf(0, 0, 1);
        double ulp = 1.0e-5;
    ...
    @Test
    public void testStdNormalGetMean() {
    ...
    @Test
    public void testStdNormalGetStandardDeviation() {
